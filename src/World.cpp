...
void World::buildScene() {
    ...
    std::unique_ptr<Lane> laneNode1(
        new Lane(Lane::Type::LilyPadAbove, Lane::Left, 100));
    ...
    std::unique_ptr<Lane> laneNode3(
        new Lane(Lane::Type::LilyPadSingle, Lane::Left, 100));
    ...
    std::unique_ptr<Lane> laneNode5(
        new Lane(Lane::Type::PavementBelow, Lane::Left, 100));
    ...
    std::unique_ptr<Lane> laneNode7(
        new Lane(Lane::Type::RoadAbove, Lane::Left, 100));
    ...
    std::unique_ptr<Lane> laneNode9(
        new Lane(Lane::Type::RoadBelow, Lane::Left, 100));
